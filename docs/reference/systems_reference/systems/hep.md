...
| <span id="angle"></span><code>angle</code> | Real | — | — | — | — | alias to [angular::angle](#angle) | — |
...
| <span id="polar_angle"></span><code>polar_<wbr>angle</code> | Real | α | — | <code>[angular::angle](#angle)</code> | <code>[angular::angle](#angle)</code> | — | [view](../hierarchies/angle.md) |
...
| <span id="scattering_angle"></span><code>scattering_<wbr>angle</code> | Real | α | — | <code>[angular::angle](#angle)</code> | <code>[angular::angle](#angle)</code> | — | [view](../hierarchies/angle.md) |
...
| <span id="solid_angle"></span><code>solid_<wbr>angle</code> | Real | — | — | — | — | alias to [angular::solid_<wbr>angle](#solid_angle) | — |
